...
class AuthenticationAdapter extends DoctrineAdapter implements 
    ...
    public function authenticate()
    {
    	...
    	if(is_object($this->oAuth2Client) AND is_object($oAuth2ProfileInfo = $this->oAuth2Client->getInfo())) { 
    		...
    		if(empty($user)) {
                ...
                // trigger event for logging activity or another stuff
                $this->getEventManager()->trigger('userActivity', null, [
                    'action'        => 'sign-up',
                    'user'          => $user,
                    'provider'      => $this->oAuth2Client->getProvider(),
                ]);
